...
class LLMService {
    static genAI = config_1.CONFIG.GEMINI_API_KEY && !config_1.CONFIG.GEMINI_API_KEY.startsWith('mock')
        ? new generative_ai_1.GoogleGenerativeAI(config_1.CONFIG.GEMINI_API_KEY)
        : null;
    /**
